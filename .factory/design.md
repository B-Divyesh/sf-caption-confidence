...
The 1200×630 social card uses the same scene and a wider crop. It was generated with the factory image deployment on 2026-09-05, reviewed for text artifacts, brands, unintended symbols, and material seams, then exported as `public/assets/caption-confidence-social.jpg`. Its source and prompt sidecar are retained in `assets/src/`.
